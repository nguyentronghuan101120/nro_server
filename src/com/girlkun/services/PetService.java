...
public class PetService {
    ...
    private void createNewPetBill(Player player, boolean iszamat, boolean isMabu, boolean isBerus, boolean isPic,
            boolean isbill, boolean iswhis, boolean isgoku, boolean iscumber, byte... gender) {
    ...
    private void createNewPetWhis(Player player, boolean iszamat, boolean isMabu, boolean isBerus, boolean isPic,
            boolean isbill, boolean iswhis, boolean isgoku, boolean iscumber, byte... gender) {
    ...
    private void createNewPetGokuvc(Player player, boolean iszamat, boolean isMabu, boolean isBerus, boolean isPic,
            boolean isbill, boolean iswhis, boolean isgoku, boolean iscumber, byte... gender) {
    ...
    private void createNewPetCumber(Player player, boolean iszamat, boolean isMabu, boolean isBerus, boolean isPic,
            boolean isbill, boolean iswhis, boolean isgoku, boolean iscumber, byte... gender) {
    ...
    private void createNewPetzamat(Player player, boolean iszamat, boolean isMabu, boolean isBerus, boolean isPic,
            boolean isbill, boolean iswhis, boolean isgoku, boolean iscumber, byte... gender) {
