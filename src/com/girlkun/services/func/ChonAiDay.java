        ...
        while (true) {
            try {
                if (((ChonAiDay.gI().lastTimeEnd - System.currentTimeMillis()) / 1000) <= 0) {
                    ...
                    ChonAiDay.gI().PlayersNormar.stream().filter(p -> p != null && p.goldNormar != 0)
                    ...
                    if (listN.size() > 5) {
                        ...
                        if (pl != null) {
                            ...
                            Service.gI().sendThongBao(pl,
                                    "Chúc mừng bạn đã dành chiến thắng và nhận được " + goldC + " thỏi vàng");
                    ...
                    listN.clear();
                    ChonAiDay.gI().PlayersVIP.stream().filter(p -> p != null && p.goldVIP != 0)
                            .sorted(Comparator.comparing(
