...
public class UseItem {
                ...
                default:
                    switch (item.template.id) {
                        ...
                        case 361:
                            ...
                            break;
                        // case 2095: // lí do nằm ở đây thì pet VIP nó phải theo số 27(tạp chủng)
                        // InventoryServiceNew.gI().itemBagToBody(pl, indexBag);
                        // PetService.Pet2(pl, 2072, 2073, 2074, null);
                        // Service.gI().point(pl);
                        // break;
                        // case 2090: // lí do
                        // InventoryServiceNew.gI().itemBagToBody(pl, indexBag);
                        // PetService.Pet2(pl, 663, 664, 665, null);
                        // Service.getInstance().point(pl);
                        // break;
                        // case 2089: // lí do
                        // InventoryServiceNew.gI().itemBagToBody(pl, indexBag);
                        // PetService.Pet2(pl, 557, 558, 559, null);
                        // Service.getInstance().point(pl);
                        // break;
                        // case 2088: // lí do
                        // InventoryServiceNew.gI().itemBagToBody(pl, indexBag);
                        // PetService.Pet2(pl, 465, 466, 467, null);
                        // Service.getInstance().point(pl);
                        // break;
                        // case 1046: // lí do
                        // InventoryServiceNew.gI().itemBagToBody(pl, indexBag);
                        // PetService.Pet2(pl, 95, 96, 97, null);
                        // Service.getInstance().point(pl);
                        // break;
                        // case 2087: // lí do
                        // InventoryServiceNew.gI().itemBagToBody(pl, indexBag);
                        // PetService.Pet2(pl, 763, 764, 765, null);
                        // Service.getInstance().point(pl);
                        // break;
                        // case 2086: // lí do
                        // InventoryServiceNew.gI().itemBagToBody(pl, indexBag);
                        // PetService.Pet2(pl, 813, 814, 815, null);
                        // Service.getInstance().point(pl);
                        // break;
                        // case 2085: // lí do
                        // InventoryServiceNew.gI().itemBagToBody(pl, indexBag);
                        // PetService.Pet2(pl, 1074, 1075, 1076, null);
                        // Service.getInstance().point(pl);
                        // break;
                        // case 2046: // lí do
                        // InventoryServiceNew.gI().itemBagToBody(pl, indexBag);
                        // PetService.Pet2(pl, 2033, 2034, 2035, null);
                        // Service.getInstance().point(pl);
                        // break;
                        // case 942: // lí do
                        // InventoryServiceNew.gI().itemBagToBody(pl, indexBag);
                        // PetService.Pet2(pl, 966, 967, 968, null);
                        // Service.gI().point(pl);
                        // break;
                        // case 943: // lí do
                        // InventoryServiceNew.gI().itemBagToBody(pl, indexBag);
                        // PetService.Pet2(pl, 969, 970, 971, null);
                        // Service.gI().point(pl);
                        // break;
                        // case 944: // lí do
                        // InventoryServiceNew.gI().itemBagToBody(pl, indexBag);
                        // PetService.Pet2(pl, 972, 973, 974, null);
                        // Service.gI().point(pl);
                        // break;
                        // case 967: // lí do
                        // InventoryServiceNew.gI().itemBagToBody(pl, indexBag);
                        // PetService.Pet2(pl, 1050, 1051, 1052, null);
                        // Service.gI().point(pl);
                        // break;
                        // case 1107: // lí do
                        // InventoryServiceNew.gI().itemBagToBody(pl, indexBag);
                        // PetService.Pet2(pl, 1183, 1184, 1185, null);
                        // Service.gI().point(pl);
                        // break;
                        // case 1209: // lí do
                        //     InventoryServiceNew.gI().itemBagToBody(pl, indexBag);
    ...
    private void openWoodChest(Player pl, Item item) {
        ...
        if (time != 0) {
            ...
            if (param < 8) {
                ...
                listItemReward = Util.pickNRandInArr(listItem, 457);
            } else {
                gold = 500000 * param;
    ...
    private void Hopts(Player pl, Item item) {// hop qua do huy diet
        NpcService.gI().createMenuConMeo(pl, item.template.id, -1, "Chọn Hành Tinh Muốn Mở Đi", "Set Trái Đất",
                "Set Namec", "Set Xayda", "Từ chối");
    }
