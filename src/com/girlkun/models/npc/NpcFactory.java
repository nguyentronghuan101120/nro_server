...
import com.girlkun.models.map.khigas.KhiGasService;
...
public class NpcFactory {
    ...
    private static Npc rongnamec(int mapId, int status, int cx, int cy, int tempId, int avartar) {
                ...
                if (canOpenNpc(player)) {
                    if (this.mapId == 5) {
                        this.createOtherMenu(player, ConstNpc.BASE_MENU,
                                "|7|Người Hãy Truy Tìm Broly Và Tiêu Diệt Chúng \bĐể Dành Lấy Trứng Linh Thú Để Đổi Lấy Phần Quà Từ Ta",
                                "Đổi Trứng Thường", "Đổi Trứng Vip",
                                "Từ chối");
                    }
                }
            }
                ...
                if (canOpenNpc(player)) {
                    if (this.mapId == 5) {
                        if (player.iDMark.isBaseMenu()) {
                            switch (select) {
                                case 0:
                                    ShopServiceNew.gI().opendShop(player, "DOITRUNGTHUONG", false);
                                    break;
                                case 1:
                                    ShopServiceNew.gI().opendShop(player, "DOITRUNGVIP", false);
                                    break;
                                case 2:
                ...
                if (canOpenNpc(player)) {
                    if (!TaskService.gI().checkDoneTaskTalkNpc(player, this)) {
                        if (player.getSession().is_gift_box) {
                            ...
                            this.createOtherMenu(player, ConstNpc.BASE_MENU, "|7|Chào con, con muốn ta giúp gì nào?",
                    ...
                    if (player.iDMark.isBaseMenu()) {
                        switch (select) {
                            ...
                            case 1:
                                ...
                                break;
                            case 2:
                                if (player.getSession().player.nPoint.power >= 80000000L) {

                                    ChangeMapService.gI().changeMapBySpaceShip(player, 153, -1, 432);
                                } else {
                                    this.npcChat(player, "Bạn chưa đủ 80 triệu sức mạnh để vào");
                                }
                                break; // qua lanh dia
    ...
    public static Npc PANCHY(int mapId, int status, int cx, int cy, int tempId, int avartar) {
        return new Npc(mapId, status, cx, cy, tempId, avartar) {
            @Override
            public void openBaseMenu(Player player) {
                if (canOpenNpc(player)) {
                    createOtherMenu(player, ConstNpc.BASE_MENU,
                            "Xin chào, Tôi có rát nhiều thú cưng cậu có muốn mua gì không?",
                            "Cửa hàng", "Từ chối");
                }
            }
                ...
                if (canOpenNpc(player)) {
                    if (this.mapId == 5) {
                        if (player.iDMark.isBaseMenu()) {
                            switch (select) {
                                case 0: // shop
                                    ShopServiceNew.gI().opendShop(player, "THUCUNG", false);
                                    break;
                                case 1:
        ...
        return new Npc(mapId, status, cx, cy, tempId, avartar) {
            ...
            public void openBaseMenu(Player player) {
                if (canOpenNpc(player)) {
                    if (this.mapId == 5) {
                        this.createOtherMenu(player, ConstNpc.BASE_MENU,
                                "Ngươi dám vào bụng ta để đánh nhau với Mabu không?", "Tới Bụng\nBư", "Từ chối");
                    } else if (this.mapId == 128) {
                        this.createOtherMenu(player, ConstNpc.BASE_MENU,
                                "Bạn Đã Bị Bư Han Nhuốt Hãy Tìm nó để tiêu diệt?", "Quay về", "Từ chối");
                    } else {
                        super.openBaseMenu(player);
                    }
                }
                ...
                if (canOpenNpc(player)) {
                    if (this.mapId == 5) {
                        this.createOtherMenu(player, ConstNpc.BASE_MENU,
                                ...
                                "Ép sao\ntrang bị", "Pha lê\nhóa trang bị",
                                "Nâng cấp\nBông tai\nPorata Cấp 3", "Mở chỉ số\nBông tai\nPorata Cấp 3",
                                "Nâng cấp\nBông tai\nPorata Cấp 4", "Mở chỉ số\nBông tai\nPorata Cấp 4");
                    ...
                    if (this.mapId == 5) {
                        if (player.iDMark.isBaseMenu()) {
                            switch (select) {
                                ...
                                case 4:
                                    CombineServiceNew.gI().openTabCombine(player,
                                            CombineServiceNew.NANG_CAP_BONG_TAI_CAP4);
                                    break;
                                case 5:
                                    CombineServiceNew.gI().openTabCombine(player,
                                            CombineServiceNew.MO_CHI_SO_BONG_TAI_CAP4);
                                    break;
                                // case 6:
                                // CombineServiceNew.gI().openTabCombine(player,
                                // CombineServiceNew.LUYEN_HOA_CHIEN_LINH);
                                // break;
                                // case 7:
                                // CombineServiceNew.gI().openTabCombine(player,
                                // CombineServiceNew.MO_GIOI_HAN_CHIEN_LINH);
                                // break;
                        ...
                        if (player.iDMark.isBaseMenu()) {
                            ...
                            // } else if (player.iDMark.getIndexMenu() ==
                            // ConstNpc.MENU_PHAN_RA_DO_THAN_LINH) {
                            // if (select == 0) {
                            // CombineServiceNew.gI().startCombine(player);
                            // }
        ...
        return new Npc(mapId, status, cx, cy, tempId, avartar) {
            ...
            public void openBaseMenu(Player player) {
                if (canOpenNpc(player)) {
                    ...
                    if (mapId == 122) {
                        this.createOtherMenu(player, 0,
                                "A Di Đà Phật!\b|7|Thí chủ đang có: " + player.NguHanhSonPoint
                                        + " điểm ngũ hành sơn\b|1|Thí chủ muốn đổi cải trang x4 chưởng ko?",
                                "Có", "Top Ngũ Hành Sơn", "Không");
                    }
                }
            }
    ...
    // switch (select) {
    // case 0:
    // NpcService.gI().createMenuConMeo(player, ConstNpc.DOI_DTVIP, 3049,
    // "Ngươi có muốn đổi đệ tử xịn hay không?\n"
    // + "|3|Tùy chọn 1: Đệ uub[30k] : Hợp thể tăng 30% \n|3|"
    // + "Tùy chọn 2: Đệ Pic[50k] : Hợp thể tăng 40% \n|3|"
    // + "Tùy chọn 3: Đệ Goku vô cực[100k] : Hợp thể tăng 50% \n|3|"
    // + "Tùy chọn 4: Đệ Cumber[150k] : Hợp thể tăng 60%",
        ...
        return new Npc(mapId, status, cx, cy, tempId, avartar) {
            ...
            public void openBaseMenu(Player player) {
                if (canOpenNpc(player)) {
                    ...
                    if (this.mapId == 141) {
                        this.createOtherMenu(player, ConstNpc.BASE_MENU,
                                "Con muốn trở về Thần Vũ Trụ không ?", "Đồng ý", "Từ chối");
                    }
                }
            }
                        ...
                        if (player.iDMark.isBaseMenu()) {
                            ...
                            switch (select) {
                                ...
                                case 1:
                                    ...
                                    break;
                                case 2:
                                    ChangeMapService.gI().changeMap(player, 141, -1, 300, 336);
                                    break;
                            }
                        }
                    }
        ...
        return new Npc(mapId, status, cx, cy, tempId, avartar) {
            ...
            public void openBaseMenu(Player player) {
                if (canOpenNpc(player)) {
                    ...
                    // + " hôm nay. Người mở\n"
                    // + "(" + player.clan.playerOpenDoanhTrai + "). Hẹn ngươi quay lại vào ngày
                    // mai",
                    // "OK", "Hướng\ndẫn\nthêm");
                    // return;
                    // }
                    ...
                    if (this.mapId == 7 * player.gender) {
                        ...
                        if (player.billEgg.getSecondDone() != 0) {
                            this.createOtherMenu(player, ConstNpc.CAN_NOT_OPEN_EGG,
                                    "Mang Đến Gặp Vua Hùng Để Được Những Món Quà Vô Giá...",
                                    "Thu Hoạch\nSớm" + Util.numberToMoney(COST_AP_TRUNG_NHANH) + " vàng", "Đóng");
                        } else {
                            this.createOtherMenu(player, ConstNpc.CAN_OPEN_EGG, "Mau thu hoạch nào...", "Thu Hoạch",
                                    "Đóng");
                        }
                    }
                }
    ...
    public static Npc npcThienSu64(int mapId, int status, int cx, int cy, int tempId, int avartar) {
        return new Npc(mapId, status, cx, cy, tempId, avartar) {
            ...
            public void openBaseMenu(Player player) {
                ...
                if (this.mapId == 145) {
                    this.createOtherMenu(player, ConstNpc.BASE_MENU,
                            "Sợ rồi à! Có muốn ta đưa ngươi về không ?",
                            "Về ngay", "Từ chối");
                }
            }
            ...
            public void confirmMenu(Player player, int select) {
                if (canOpenNpc(player)) {
                    if (player.iDMark.isBaseMenu() && this.mapId == 7) {
                        if (select == 0) {
                            if (player.getSession().player.nPoint.power >= 80000000000L
                                ...
                                player.inventory.gold -= COST_HD;
                                Service.gI().sendMoney(player);
                                ChangeMapService.gI().changeMapBySpaceShip(player, 146, -1, 159);
                            } else {
                    ...
                    if (player.iDMark.isBaseMenu() && (this.mapId == 146 || this.mapId == 147 || this.mapId == 148)) {
                        if (select == 0) {
                            if (player.gender == 0) {
                                ChangeMapService.gI().changeMapBySpaceShip(player, 0, -1, 600);
                            } else if (player.gender == 1) {
                                ChangeMapService.gI().changeMapBySpaceShip(player, 7, -1, 600);
                            } else if (player.gender == 2) {
                                ChangeMapService.gI().changeMapBySpaceShip(player, 14, -1, 680);
                            }
                        }
                        if (select == 1) {
                        }
                    ...
                    if (player.iDMark.isBaseMenu() && this.mapId == 154) {
                        switch (select) {
                            case 0:
                                ...
                                break;
                            case 1:
                                Item BiKiepTuyetKy = InventoryServiceNew.gI().findItem(player.inventory.itemsBag, 2113);
                        ...
                        switch (select) {
                            case 0:
                                Item sach = InventoryServiceNew.gI().findItemBag(player, 2113);
            ...
            public void openBaseMenu(Player player) {
                if (canOpenNpc(player)) {
                    if (this.mapId == 47 || this.mapId == 84) {
                        this.createOtherMenu(player, ConstNpc.BASE_MENU,
                                "|7|Xin chào ta có thể giúp gì cho cậu!",
                                "Nhiệm vụ\nhàng ngày", "Từ chối");
                    }
                    // if (this.mapId == 47) {
                    // this.createOtherMenu(player, ConstNpc.BASE_MENU,
            ...
            public void openBaseMenu(Player player) {
                if (canOpenNpc(player)) {
                    if (this.mapId == 5) {
                        if (!TaskService.gI().checkDoneTaskTalkNpc(player, this)) {
                            this.createOtherMenu(player, ConstNpc.BASE_MENU,
                                    "|1|Cửa Hàng Của Ta Sưu Tầm Những Đồ Vip Độc Lạ"
                                            ...
                                            + "\n|5|Đổi Hồng Ngọc "
                                            + "\n|6|Có Rồi Hả? Giỏi,Hãy Mang Cho Ta nào",
                                    "Cửa Hàng", "Đóng");
                        }
                    } else if (this.mapId == 104) {
                        this.createOtherMenu(player, ConstNpc.BASE_MENU, "Kính chào Ngài Linh thú sư!", "Cửa hàng",
    ...
    public static Npc vados(int mapId, int status, int cx, int cy, int tempId, int avartar) {
        return new Npc(mapId, status, cx, cy, tempId, avartar) {
            ...
            public void openBaseMenu(Player player) {
                if (canOpenNpc(player)) {
                    createOtherMenu(player, ConstNpc.BASE_MENU,
                            "|2|Ta Vừa Hack Map Xem Được Top Của Toàn Server\b|7|Mi Muốn Xem Top Gì?",
                ...
                if (canOpenNpc(player)) {
                    switch (player.iDMark.getIndexMenu()) {
                        case ConstNpc.BASE_MENU:
                            ...
                            if (this.mapId == 131) {
                                if (select == 0) {
                                    ChangeMapService.gI().changeMapBySpaceShip(player, 80, -1, 769);
                                }
                            }
                            break;
                    }
        ...
        return new Npc(mapId, status, cx, cy, tempId, avartar) {
            ...
            public void openBaseMenu(Player player) {
                if (canOpenNpc(player)) {
                    if (!TaskService.gI().checkDoneTaskTalkNpc(player, this)) {
                        this.createOtherMenu(player, ConstNpc.BASE_MENU,
                                "Tôi là Unkonw, bạn muốn tôi giúp đỡ gì cho bạn?",
                                "Cửa hàng", "Quy đổi");
                    }
                }
            }
        ...
        return new Npc(mapId, status, cx, cy, tempId, avartar) {
            ...
            public void openBaseMenu(Player player) {
                if (canOpenNpc(player)) {
                    if (this.mapId == 20) {
                        this.createOtherMenu(player, ConstNpc.BASE_MENU,
                                "Bạn Đã Bị Bư béo Nuốt Hãy Tìm nó để tiêu diệt<");
                        ChangeMapService.gI().changeMapBySpaceShip(player, 128, -1, 432);
                    } else {
                        this.createOtherMenu(player, ConstNpc.BASE_MENU,
                                "Bạn Đã Bị Bư béo Nuốt Hãy Tìm nó để tiêu diệt?", "Sợ chưa để anh về nhe cuuu");
                    }
                    super.openBaseMenu(player);
                    if (this.mapId == 128) {
                        this.createOtherMenu(player, 0,
                        ...
                        if (pl.iDMark.getIndexMenu() == 0) {
                            if (select == 0) {
                                ...
                                createOtherMenu(pl, 1, "Tổng giải thường: " + ChonAiDay.gI().goldNormar
                                        ...
                                        + pl.goldVIP + "\n Thời gian còn lại: " + time, "Cập nhập",
                                        "Thường\n20 thỏi\nvàng", "VIP\n200 thỏi\nvàng", "Đóng");
                            }
                ...
                if (canOpenNpc(player)) {
                    if (!TaskService.gI().checkDoneTaskTalkNpc(player, this)) {
                        if (player.getSession().is_gift_box) {
                            ...
                            this.createOtherMenu(player, ConstNpc.BASE_MENU,
                                    "Trái đất đang pị mụt con iu quoái tên là xấu xí thải 1 lượng lớn Amoniac ra môi trường khiến trái đất ô nhiễm nặng dẫn đến đà suy vong mấy đứa ơi?",
                                    "Khí Gas");
                        }
                    }
                }
            ...
            public void confirmMenu(Player player, int select) {
                if (canOpenNpc(player)) {
                    if (player.iDMark.isBaseMenu()) {
                        switch (select) {
                            case 0:
                                if (player.clan != null) {
                                    if (player.clan.banDoKhoBau != null) {
                                        this.createOtherMenu(player, ConstNpc.MENU_OPENED_DBKB,
                                                "Bang hội của con đang đi tìm Khí Gas cấp độ",
                                                +player.clan.banDoKhoBau.level + "\nCon có muốn đi theo không?",
                                                "Đồng ý", "Từ chối");//
                                    } else {
                                        ...
                                        this.createOtherMenu(player, ConstNpc.MENU_OPEN_KG,
                                                "Các con cứ yên tâm lên đường\n",
                                                "Ở đây có ta lo\nNhớ chọn cấp độ vừa sức mình nhé", "Từ chối");
                                    }
                                } else {
                                    this.npcChat(player, "Con phải có bang hội ta mới có thể cho con đi");
                                }
                        ...
                        switch (select) {
                            case 0:
                                KhiGasService.gI().openKhiGas(player,
                                        Byte.parseByte(String.valueOf(PLAYERID_OBJECT.get(player.id))));
                                break;
                        }
                    }
    ...
    /*
     * public static Npc npcminuong(int mapId, int status, int cx, int cy, int
     * tempId, int avartar) {
     * return new Npc(mapId, status, cx, cy, tempId, avartar) {
     * 
     * @Override
     ...
     * if (this.mapId == 164) {
     * this.createOtherMenu(player, ConstNpc.BASE_MENU,
     * "Cậu không chịu nổi khi ở đây sao?\nCậu sẽ khó mà mạnh lên được", "Trốn về",
     * "Ở lại");
     * }
     * 
     * @Override
        ...
        try {
            switch (tempId) {
                ...
                case ConstNpc.PANCHY:
                    return PANCHY(mapId, status, cx, cy, tempId, avatar);
                case ConstNpc.RONG_NAMEC:
                    return rongnamec(mapId, status, cx, cy, tempId, avatar);
                            ...
                            case 0:
                                if (player.getSession().coinBar >= 30000) {
                                    if (player.pet == null) {
                                        ...
                                        try {
                                            // player.getSession().coinBar -= 30000; // dong nay nefix dum e vdoi hn ko
                                            // tru vs
                                            // cho nao

                                            PlayerDAO.subcoinBar(player, 30000);
                                            PetService.gI().changeBillPet(player, player.gender);
                                            // GirlkunDB.executeUpdate("update player set coinBar = (coinBar - 300000)
                                            // where id = " + player.id);
                                ...
                                if (player.getSession().coinBar >= 100000) {
                                    if (player.pet == null) {
                                        ...
                                        try {
                                            ...
                                            // GirlkunDB.executeUpdate("update player set coinruby = (coinruby - 100000)
                                            // where id = " + player.id);
                                            Service.getInstance().sendThongBao(player, "Đổi thành công");
                                        } catch (Exception ex) {
                                            java.util.logging.Logger.getLogger(NpcFactory.class.getName())
                                ...
                                if (player.getSession().coinBar >= 150000) {
                                    if (player.pet == null) {
                                        ...
                                        try {
                                            ...
                                            // GirlkunDB.executeUpdate ("player set coinruby = (coinruby - 100000 where
                                            // id = + player.id");
                                            Service.getInstance().sendThongBao(player, "Đổi thành công");
                                        } catch (Exception ex) {
                                            java.util.logging.Logger.getLogger(NpcFactory.class.getName())
                                ...
                                if (player.getSession().coinBar >= 200000) {
                                    if (player.pet == null) {
                                        ...
                                        try {
                                            ...
                                            // GirlkunDB.executeUpdate("update player set coinBar = (coinBar - 200000)
                                            // where id = " + player.id);
                                            Service.getInstance().sendThongBao(player, "Đổi thành công");
                                        } catch (Exception ex) {
                                            java.util.logging.Logger.getLogger(NpcFactory.class.getName())
