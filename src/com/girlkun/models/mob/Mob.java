...
public class Mob {
    ...
    private List<ItemMap> mobReward(Player player, ItemMap itemTask, Message msg) {
        ...
        try {
            if ((!player.isPet && player.getSession().actived && player.setClothes.setDHD == 5) || (player.isPet
                    && ((Pet) player).master.getSession().actived && ((Pet) player).setClothes.setDHD == 5)) {
                byte random = 1;
            ...
            if ((!player.isPet && player.getSession().actived && player.setClothes.setGod() == true
            ...
            if ((!player.isPet && player.getSession().actived && player.setClothes.setGod14() == true
                    && (this.zone.map.mapId > 159 && this.zone.map.mapId < 164 || this.zone.map.mapId == 155))) {
                if (Util.isTrue(100, 100)) {
